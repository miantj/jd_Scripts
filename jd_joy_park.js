...
[task_local]
#汪汪乐园养joy
20 0-23/3 * * * jd_joy_park.js, tag=汪汪乐园养joy, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_joypark_joy.png, enabled=true
================Loon==============
[Script]
cron "15 0-23/3 * * *" script-path=jd_joy_park.js,tag=汪汪乐园养joy
===============Surge=================
汪汪乐园养joy = type=cron,cronexp="20 0-23/3 * * *",wake-system=1,timeout=3600,script-path=jd_joy_park.js
============小火箭=========
汪汪乐园养joy = type=cron,script-path=jd_joy_park.js, cronexpr="20 0-23/3 * * *", timeout=3600, enable=true
*/
