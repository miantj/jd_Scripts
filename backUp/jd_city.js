...
[task_local]
#城城领现金
2 0-23/6 9-21 1 * jd_city.js, tag=城城领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
 */
const $ = new Env('城城领现金');
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: `https://cdn.jsdelivr.net/gh/6dylan6/updateTeam@main/shareCodes/jd_city.json`, 'timeout': 10000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
