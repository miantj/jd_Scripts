...
!(async () => {
  ...
  console.log('默认前6个ck开团，变量CITYNUM,运行流程：收集助力码-助力-前10ck做任务\n');
  if (exchangeFlag) {
    console.log(`自动抽奖`)
  } else {
...
function getInfo(inviteId, flag = false) {
  let body = { "lbsCity": "15", "realLbsCity": "1233", "inviteId": inviteId, "headImg": "", "userName": "", "taskChannel": "4", "location": "", "safeStr": "{\"log\":\"1670634551419~\",\"sceneid\":\"CHFhPagewx\",\"random\":\"51624039\"}" }
