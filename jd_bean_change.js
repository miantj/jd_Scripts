...
let RemainMessage = '\n';
RemainMessage += "⭕提醒:⭕" + '\n';
RemainMessage += '【极速金币】京东极速版->我的->金币(兑换无门槛红包)\n';
RemainMessage += '【京东赚赚】微信->京东赚赚小程序->底部赚好礼->提现无门槛红包(京东使用)\n';
RemainMessage += '【京东秒杀】京东->首页京东秒杀->点立即签到->可兑换无门槛红包(京东使用)\n';
RemainMessage += '【东东萌宠】京东->我的->东东萌宠,完成是京东红包,可用于京东商城的任意商品\n';
RemainMessage += '【领现金】京东->搜玩一玩>领现金(微信提现+京东红包)\n';
RemainMessage += '【东东农场】京东->我的->东东农场,京东无门槛红包,可用于京东商城的任意商品\n';
RemainMessage += '【京喜工厂】京喜->我的->京喜工厂,完成是商品红包,购买指定商品(不兑换会过期)\n';
