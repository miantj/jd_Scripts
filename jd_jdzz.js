...
[task_local]
# 京东赚赚
8 0,4 * * * jd_jdzz.js, tag=京东赚赚, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdzz.png, enabled=true
================Loon==============
[Script]
cron "8 0,4 * * *" script-path=jd_jdzz.js,tag=京东赚赚
===============Surge=================
京东赚赚 = type=cron,cronexp="8 0,4 * * *",wake-system=1,timeout=3600,script-path=jd_jdzz.js
============小火箭=========
京东赚赚 = type=cron,script-path=jd_jdzz.js, cronexpr="8 0,4 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东赚赚');
...
const inviteCodes = ['T020Z0j0lYu9LdFR9JJJQH-wCjVWnYaS5kRrbA']
