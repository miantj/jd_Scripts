...
[task_local]
#宠汪汪积分兑换奖品
59 23,7,15 * * * jd_joy_reward.js, tag=宠汪汪积分兑换奖品, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true
==============Loon==============
[Script]
cron "59 23,7,15 * * *" script-path=jd_joy_reward.js,tag=宠汪汪积分兑换奖品
================Surge===============
宠汪汪积分兑换奖品 = type=cron,cronexp="59 23,7,15 * * *",wake-system=1,timeout=3600,script-path=jd_joy_reward.js
===============小火箭==========
宠汪汪积分兑换奖品 = type=cron,script-path=jd_joy_reward.js, cronexpr="59 23,7,15 * * *", timeout=3600, enable=true
 */
// prettier-ignore
