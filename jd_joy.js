...
[task_local]
#京东宠汪汪
20 0-23/2 * * * jd_joy.js, tag=京东宠汪汪, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdcww.png, enabled=true
============Loon===========
[Script]
cron "20 0-23/2 * * *" script-path=jd_joy.js,tag=京东宠汪汪
============Surge==========
[Script]
京东宠汪汪 = type=cron,cronexp="20 0-23/2 * * *",wake-system=1,timeout=3600,script-path=jd_joy.js
===============小火箭==========
京东宠汪汪 = type=cron,script-path=jd_joy.js, cronexpr="20 0-23/2 * * *", timeout=3600, enable=true
*/
const $ = new Env('宠汪汪');
